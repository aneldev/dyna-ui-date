        ...
        return (React.createElement(dyna_ui_picker_container_1.DynaPickerContainer, { style: dyna_ui_picker_container_1.EStyle.ROUNDED, color: colors.pickerContainerColor, show: show },
            React.createElement("div", { className: "ddp-picker-container" },
                ...
                React.createElement("div", { className: "ddp--calendar--button-bar" },
                    showTodayButton ?
                        React.createElement(dyna_ui_button_1.DynaButton, { style: dyna_ui_button_1.EStyle.ROUNDED, color: colors.pickerButtonColor, size: dyna_ui_field_wrapper_1.ESize.LARGE, disabled: todayButtonDisabled, touchTimeout: 50, onClick: this.handlerTodayClick.bind(this) }, todayButtonLabel)
                        : null,
                    showCloseButton ?
                        React.createElement(dyna_ui_button_1.DynaButton, { style: dyna_ui_button_1.EStyle.ROUNDED, color: colors.pickerButtonColor, size: dyna_ui_field_wrapper_1.ESize.LARGE, touchTimeout: 50, onClick: this.handlerUserCame.bind(this) }, closeButtonLabel)
                        : null),
                pickerFooter)));
    };
